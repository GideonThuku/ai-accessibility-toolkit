...
def run_about_page():
    ...
    st.title("Welcome to the AI Accessibility Toolkit 🚀")
...
def run_language_scanner():
    ...
    st.title("🤝 Inclusive Language Scanner")
...
def main():
    ...
    st.set_page_config(page_title="AI Accessibility Toolkit", page_icon="♿")
